<li class="cc-product-grid-item">
    ...
    <div class="cc-product-grid-image-container">
        <a href="<?php echo get_permalink( $post->ID ); ?>" title="<?php echo $post->post_title ?>"><img src="<?php echo $thumbnail_src; ?>" class="cc-grid-item-image" alt="<?php echo $alt; ?>" /></a>
    </div>

    <h2 class="cc-product-grid-title"><?php echo $post->post_title; ?></h2>
